...
array( "name" => $themename." Options",
	...
	array(  "name" => "Twiiter settings",
            "type" => "section"),
    array( "type" => "open"),

	array(  "name" => "Enable/Disable Twitter widget",
    ...
    array(  "name" => "Twitter Username",
            "id" => $shortname."_tuser",
            "std" => "simplewpthemes",
            "desc" => "Enter your Twitter username, for example - simplewpthemes",
            "type" => "text"),

    array(  "name" => "Number of Tweets",
            "id" => $shortname."_num_of_tweets",
            "std" => "3",
            "desc" => "Enter the number of Tweets that you want to be displayed",
            "type" => "text"),
