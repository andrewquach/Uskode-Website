...
$document->addScript(JURI::base() . 'modules/mod_sptab/assets/js/sptab_moo' . $moo . '.js');//Load javascript
$document->addStylesheet(JURI::base() . 'modules/mod_sptab/assets/css/' . $style . '.css.php?id=' .$uniqid);//Load css

$css = '';
$css 		.= '#sptab' . $uniqid . ' .tabs_mask, #sptab' . $uniqid . ' ul.tabs_container li span {height:' . $height . 'px;line-height:' . $height . 'px; font-weight:bold;}';
