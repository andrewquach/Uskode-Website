...
<div class="componentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" style="font-family:arial;font-size:14px;font-weight:bold;">
	<?php echo $this->escape($this->params->get('page_title')); ?>
</div>
<?php endif; ?>
<table class="blog<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" cellpadding="0" cellspacing="0" style="margin-right:15px;">
		...
		<?php
			...
			if ($this->params->def('multi_column_order', 0)) : // order across, like front page
				...
				for ($z = 0; $z < $this->params->get('num_columns'); $z ++) :
					if ($z > 0) : $divider = " column_separator"; endif; ?>
					<td valign="top" height="145px" width="<?php echo intval(100 / $this->params->get('num_columns')) ?>%" class="article_column<?php echo $divider ?>">
